...
class Tests(TestCase):
    ...
    def test_set_invalid_size_raises(self):
        plantation = Plantation(10)
    ...
    def test_hire_invalid_worker_raises(self):
        plantation = Plantation(10)
    ...
    def test_planting_invalid_worker_raises(self):
        plantation = Plantation(10)
        plantation.hire_worker("Boris")
    ...
    def test_str_return_correct_data(self):
        plantation = Plantation(10)
        plantation.hire_worker("Boris")
        plantation.hire_worker("Ivan")
        plantation.planting("Boris", "Spelt")
