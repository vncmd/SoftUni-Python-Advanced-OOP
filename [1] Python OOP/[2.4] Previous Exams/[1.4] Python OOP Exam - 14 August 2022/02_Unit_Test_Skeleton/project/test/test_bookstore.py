...
class Tests(TestCase):
    ...
    def test_set_valid_book_limit(self):
        bookstore = Bookstore(10)
        bookstore.books_limit = 1

        self.assertEqual(1, bookstore.books_limit)

    def test_set_invalid_book_limit_raises(self):
        bookstore = Bookstore(10)
    ...
    def test_receive_book_returns_correct_message(self):
        bookstore = Bookstore(10)
        bookstore.receive_book("The Hobbit", 2)
    ...
    def test_sell_invalid_book_raises(self):
        bookstore = Bookstore(10)
        bookstore.receive_book("The Hobbit", 2)
    ...
    def test_sell_book_with_insufficient_quantity_raise(self):
        bookstore = Bookstore(10)
        bookstore.receive_book("The Hobbit", 2)
