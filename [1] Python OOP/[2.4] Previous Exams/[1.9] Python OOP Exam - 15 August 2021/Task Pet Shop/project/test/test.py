...
class Tests(TestCase):
    ...
    def test_add_invalid_pet_raises(self):
        shop = PetShop("Animalia")
        shop.add_pet("Jackie")
    ...
    def test_feed_pet_with_invalid_food_raises(self):
        shop = PetShop("Animalia")
    ...
    def test_feed_with_available_less_than_100_adds_food_and_returns_message(self):
        shop = PetShop("Animalia")
